...
//       This example utilizes the stripe passport strategy. 
...
function oAuthStripeConnector( parentDirPath ){
	...
	*/
	this.doConnectStep = function( done, pipeRunStep, pipeRunStats, pipeRunLog, pipe, pipeRunner ){
		...
		// initialize the stripe API library
	...
	this.fetchRecords = function( dataSet, pushRecordFn, done, pipeRunStep, pipeRunStats, pipeRunLog, pipe, pipeRunner ){
		...
		switch(dataSet.name) {
			case 'customer' : 
								pipeRunLog.info('Fetching customer data.');												
								// stripeOAuthConsumer.customers.list(... // see https://stripe.com/docs/api/node#list_customers
								records.push({ id: 'cus_6yIrUZsgGXKzaD', object: 'customer', account_balance: 0, created: 1442096055, currency: 'usd', default_source: 'card_16kMGBJV7gNMExYZvJi3ucWr', email: 'proident.enim@consectetur.ipsum'});
								break;
			case 'invoice' : 
								pipeRunLog.info('Fetching invoice data.');												
								// stripeOAuthConsumer.invoices.list(... // see https://stripe.com/docs/api/node#list_invoices
								records.push({id: 'sub_85wZZrHvAxzK7P', object: 'line_item', amount: 765, currency: 'usd', description: null});
								break;
			// ...		
			default:
								pipeRunLog.error('This stripe connector cannot process data set ' + dataSet.name);												
		} 
     ...
     * {@link https://stripe.com/docs/api/node#intro}
     * @param {Object} pipe - data pipe configuration
     */
