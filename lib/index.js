...
function oAuthRunKeeperConnector( parentDirPath ){
	...
	this.getPassportStrategy = function(pipe) {
		...
		return new dataSourcePassportStrategy({
	        ...
	        callbackURL: global.getHostUrl() + '/authCallback' //"https://localhost:8082" + '/authCallback'					 // mandatory; oAuth callback; do not change
		  },
	...
	*/
	...
	var getFitnessActivities = function(pushRecordFn, pipeRunLog, pipe, done) {
